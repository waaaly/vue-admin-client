<template>
	<div  class="footBack">
	    <div class="fcontainer">
	        ...
	        <p>
	            © 2020 <a href="/">Waaaly</a>. 由 <a href="https://cn.vuejs.org/" target="_blank">Vue</a> 强力驱动. 
				Theme By <a href="http://mangoya.cn/" target="_blank">mangoya/</a>. 京ICP备17071595号-1.
	        </p>
	        <p>
	            <span>Made with</span> 
				<img class="fheart" src="../../assets/img/heart.gif"/>  
				<span>by Waaaly.</span>
	        </p>
	    </div>
	</div>
